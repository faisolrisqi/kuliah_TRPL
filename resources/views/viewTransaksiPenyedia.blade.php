					...
					<div class="row">
						<div class="col-md-9">
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<h3 class="panel-title">Daftar Penyewaan Diterima</h3>
								</div>
								 <div class="panel-body table-responsive table-full">
									<table class="table table-stripped table-bordered">
									...
									<tr>
										...
										@foreach($muncul2 as $data2)
										<tr>
											<td class="text-center text-nowrap">{{$data2->id_Sewa}}</td>
											<td class="text-center text-nowrap">{{$data2->datakesenian->namaKesenian}}</td>
											<td class="text-center text-nowrap">{{$data2->penyedia}}</td>
											<td class="text-center text-nowrap">{{$data2->datakesenian->id}}</td>
											<td class="text-center text-nowrap">{{$data2->status}}</td>
